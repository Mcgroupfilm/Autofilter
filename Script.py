...
Aᴅᴅ Mᴇ Tᴏ Yᴏᴜʀ Gʀᴏᴜᴩ Nᴏᴡ 👇</b>"""
    ...
    HELP_TXT = """<b>Hᴇʏ {} Fʀɪᴇɴᴅ Hᴇʀᴇ Yᴏᴜʀ Bᴜᴛᴛᴏɴs 👇
    
    🎬 𝖬𝗈𝗏𝗂𝖾 𝖦𝗋𝗈𝗎𝗉 @Mᴄ_Gʀᴏᴜᴘ_Fɪʟᴍs

    😎 𝖯𝗈𝗐𝖾𝗋𝖾𝖽 𝖻𝗒 @Tʜɪʀᴀɴɪɪᴛsᴍᴇ

    📢 Uᴘᴅᴀᴛᴇ Cʜᴀɴɴᴇʟ.  @Mᴄ_Fɪʟᴍs_Uᴘᴅᴀᴛᴇ</b>"""
...
"""
    ...
    ABOUT_TXT = """<b>🤖 ᴍʏ ɴᴀᴍᴇ : ᴍᴏᴠɪᴇs ғɪʟᴛᴇʀ ʙOT
👨‍💻 ᴅᴇᴠᴇʟᴏᴘᴇʀ : <a href=https://t.me/Thiraniitsme>𝐓𝐡𝐢𝐫𝐚𝐧</a>
📝 ʟᴀɴɢᴜᴀɢᴇ : ᴘʏʀᴏɢʀᴀᴍ
📚 ꜰʀᴀᴍᴇᴡᴏʀᴋ : ᴘʏᴛʜᴏɴ 3
📡 ʜᴏsᴛᴇᴅ ᴏɴ : 𝐑𝐞𝐧𝐝𝐞𝐫
📢 sᴜᴘᴘᴏʀᴛ ɢʀᴏᴜᴘ : <a href=https://t.me/Mc_Group_Films>ᴄʟɪᴄᴋ ʜᴇʀᴇ</a>
🌟 Sᴏᴜʀᴄᴇ Cᴏᴅᴇ : <a href=https://t.me/Thiraniitsme>REPO</a></b>"""
...
<b>Fɪʀsᴛ Jᴏɪɴ Tʜɪs Gʀᴏᴜᴩ » https://t.me/Mc_Group_Films</b>

<b>Sᴇɴᴅ Yᴏᴜ Wᴀɴᴛ Mᴏᴠɪᴇs Oʀ Sᴇʀɪᴇs Nᴀᴍᴇ Wɪᴛʜ Cᴏʀʀᴇᴄᴛ Sᴩᴇʟʟɪɴɢ</b>

<b>Aɴᴅ Bᴏᴛ Wɪʟʟ Sᴇɴᴅ Yᴏᴜ Asᴋᴇᴅ Fɪʟᴇ</b>

<b>Hᴏᴡ Tᴏ Oᴩᴇɴ Bᴏᴛ Sᴇɴᴅᴇᴅ Fɪʟᴇ Lɪɴᴋ. » <a href=https://t.me/mightylink/6>ᴛᴜᴛᴏʀɪᴀʟ</a>.﹤/b>"""
